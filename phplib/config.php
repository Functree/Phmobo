...
define( 'FUNCTREE_SMTP_HOST', "smtp.aa.com" );//邮箱的SMTP服务器地址
define( 'FUNCTREE_SMTP_PORT', 25 );//邮箱的SMTP服务器端口号
define( 'FUNCTREE_SMTP_USERNAME', "noreply@aa.cn" );//SMTP邮箱的用户名称，如果为""则不需要认证
define( 'FUNCTREE_SMTP_PASSWORD', "pwd" );//SMTP邮箱的登录密码
define( 'FUNCTREE_SMTP_SECURE', "" );//SMTP邮箱是否使用安全加密方式登录：tls ssl，如果为""则不使用加密方式

//“系统管理员”账号Email，需要自定义；“系统管理员”账号默认具有“系统管理员角色”
define( 'FUNCTREE_ADMINISTRATOR_EMAIL', "admin@email.com" );
//“系统管理员”账号密码，需要自定义
define( 'FUNCTREE_ADMINISTRATOR_PASSWORD', "pwd" );

//MongoDB数据库连接字符串，需要自定义
define( 'FUNCTREE_MONGODB_CONNECTION', "mongodb://dbuser:dbpwd@localhost:27017/Phmobo" );
